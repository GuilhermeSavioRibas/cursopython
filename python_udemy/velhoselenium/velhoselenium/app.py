...
class ChromeAuto:
    def __init__(self):
        ...
        self.options.add_argument(r'user-data-dir=C:\Users\Ribas\AppData\Local\Google\Chrome\User Data\Default')
    ...
    def faz_login(self):
        try:
            ...
            input_login.send_keys('meuemail')
            input_password.send_keys('minhasenha')
            sleep(3)
            btn_login.click()
