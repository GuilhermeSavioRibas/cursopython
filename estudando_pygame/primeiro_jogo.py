...
pygame.mixer.music.play(-1)   #  -1 toca repetidamente
...
def reiniciar_jogo():
    ...
    lista_cabeca = []
    x_maca = randint(40, 600)
    y_maca = randint(60, 440)
    morreu = False


while True:
    relogio.tick(30)  # frames por segundo (quanto maior mais rapido vai rodar)
    ...
    tela.blit(texto_formatado, (450, 40))  #  texto na tela


                         #      r  g  b      X,   Y,   raio
    # pygame.draw.circle(tela, (0, 0, 255), (300, 260), 40)
                         #   r    g   b   x[0] y[0]  x[1] y[1] expessura
