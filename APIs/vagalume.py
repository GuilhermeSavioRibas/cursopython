...
pesquisa = find(input('Artista: '), input('Musica: '))
print('-='*15)
print(pesquisa.song.name, ' - ', pesquisa.artist.name)
print()
print(pesquisa.song.lyric)
print()
print('-='*15)
print()
print(pesquisa.get_translation_to(language='pt-br').name, ' - ', pesquisa.artist.name)
print()
print(pesquisa.get_translation_to(language='pt-br').lyric)
